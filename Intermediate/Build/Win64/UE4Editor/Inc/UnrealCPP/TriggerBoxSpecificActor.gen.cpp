...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_ATriggerBoxSpecificActor()
	{
		...
		if (!OuterClass)
		{
...
#endif
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_MyProjectile_MetaData[] = {
				{ "Category", "TriggerBoxSpecificActor" },
				{ "ModuleRelativePath", "TriggerBoxSpecificActor/TriggerBoxSpecificActor.h" },
			};
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_MyProjectile = { UE4CodeGen_Private::EPropertyClass::Object, "MyProjectile", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000001, 1, nullptr, STRUCT_OFFSET(ATriggerBoxSpecificActor, MyProjectile), Z_Construct_UClass_AUnrealCPPProjectile_NoRegister, METADATA_PARAMS(NewProp_MyProjectile_MetaData, ARRAY_COUNT(NewProp_MyProjectile_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_MyProjectile,
	...
	IMPLEMENT_CLASS(ATriggerBoxSpecificActor, 80495087);
